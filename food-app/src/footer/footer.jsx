    ...
    <div className="footer">
      ...
      <div className='content'>
        ...
        <div id='contact-info' className='contact'>
          <h2>Contact</h2>
          <a className='phone'>Tel. 07 000 00 00</a>
          <a href="mailto:food.explorer@hotmail.com">
            <p className='mail'>food.explorer@hotmail.com</p>
          </a>
        </div>
      
        <div id='opening-info' className='opening'>
          <h2>Opening hours</h2>
          <p>monday - friday: 09-17</p>
          <p>weekends: closed</p>
        </div>
      ...
      <div className='copyrightContent'>
        <p className='copyright'>©2024 Food Explorer</p>
      </div>
    </div>
  );
}
